...
Previous research has found evidence that L1 categories predict the ease of acquisition of an L2, where sounds that differently contrast in the L2 are more difficult to acquire (e.g. the /i/ contrast /I/ in English by speakers of Spanish). 
]]
...
.full-width[
.content-box-grey[
**Specifically**: When the L3 vowel... 

was contained in both the L1 and L2 (/i/), no evidence was found of a favored L1 nor L2.

was English-like (wedge), both groups showed an English word preference 

was meant to be Spanish-like (/o/), participants treated it as similarly to the wedge.

was in neither the L1 or L2 (/y/), participants assimilated it to /u/
]]]
...
.pull-left[
**Neither language status (order of acquisition) nor global language similarity impact categorizations**
...
It is unclear whether L3 learning and L2 learning should be considered distinct in perception, if one thinks of the L1 and L2 as a single language with many categories. 

L3 learners have access to both their L1 and L2 and seem to be guided by acoustics, as opposed to global typology or order of acquisition. 
