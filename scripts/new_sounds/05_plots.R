...
# Visualize the Spanish L1 group
...
desc_df_all %>% 
  ...
  ggsave(here("data", "plots", "new_sounds", "desc_i.png"),
         dpi = 1200)
...
desc_df_all %>% 
  ...
  ggsave(here("data", "plots", "new_sounds", "desc_y.png"),
         dpi = 1200) 
...
comb = rbind(stim_data, stim_data_eng, stim_data_span)
